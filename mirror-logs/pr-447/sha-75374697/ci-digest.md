<!-- AWA-CI-DIGEST -->
## CI digest for `75374697`

- **Preview URL**: n/a
- **Mirror path**: ci-logs/mirror-logs/pr-447/latest
- **Workflow run**: [18757488063](https://github.com/AlexBomber12/AWA-App/actions/runs/18757488063)

| Job | Conclusion | URL |
| --- | ---------- | --- |
| unit | ❌ Failure | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18757488063/job/53513125474) |
| migrations | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18757488063/job/53513220209) |
| integration | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18757488063/job/53513220300) |
| preview | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18757488063/job/53513220304) |
| mirror_logs | ⏳ In Progress | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18757488063/job/53513220178) |
...
Collecting keepa==1.3.15 (from -r services/etl/requirements.txt (line 1))
  Using cached keepa-1.3.15-py3-none-any.whl.metadata (11 kB)
...
time="2025-10-23T18:01:37Z" level=warning msg="The \"PG_USER\" variable is not set. Defaulting to a blank string."
time="2025-10-23T18:01:37Z" level=warning msg="The \"PG_PASSWORD\" variable is not set. Defaulting to a blank string."
time="2025-10-23T18:01:37Z" level=warning msg="The \"PG_DATABASE\" variable is not set. Defaulting to a blank string."
time="2025-10-23T18:01:37Z" level=warning msg="The \"PG_PASSWORD\" variable is not set. Defaulting to a blank string."
time="2025-10-23T18:01:37Z" level=warning msg="The \"PG_HOST\" variable is not set. Defaulting to a blank string."
time="2025-10-23T18:01:37Z" level=warning msg="The \"PG_PORT\" variable is not set. Defaulting to a blank string."
time="2025-10-23T18:01:37Z" level=warning msg="The \"PG_USER\" variable is not set. Defaulting to a blank string."
time="2025-10-23T18:01:37Z" level=warning msg="The \"PG_PASSWORD\" variable is not set. Defaulting to a blank string."
time="2025-10-23T18:01:37Z" level=warning msg="The \"PG_DATABASE\" variable is not set. Defaulting to a blank string."
time="2025-10-23T18:01:37Z" level=warning msg="The \"PG_USER\" variable is not set. Defaulting to a blank string."
...
Requirement already satisfied: greenlet>=1 in /opt/hostedtoolcache/Python/3.11.13/x64/lib/python3.11/site-packages (from sqlalchemy==2.0.43->-r services/api/requirements.txt (line 4)) (3.2.4)
Requirement already satisfied: Mako in /opt/hostedtoolcache/Python/3.11.13/x64/lib/python3.11/site-packages (from alembic==1.16.4->-r services/api/requirements.txt (line 5)) (1.3.10)
Requirement already satisfied: botocore<1.41.0,>=1.40.21 in
