<!-- AWA-CI-DIGEST -->
## CI digest for `02212e92`

- **Preview URL**: n/a
- **Mirror path**: ci-logs/mirror-logs/pr-469/latest
- **Workflow run**: [18921388157](https://github.com/AlexBomber12/AWA-App/actions/runs/18921388157)

| Job | Conclusion | URL |
| --- | ---------- | --- |
| secrets scan (gitleaks) | ✅ Success | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18921388157/job/54018144066) |
| unit | ❌ Failure | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18921388157/job/54018144034) |
| k6 smoke (non-blocking) | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18921388157/job/54018395903) |
| integration | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18921388157/job/54018396042) |
| migrations | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18921388157/job/54018396045) |
| preview | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18921388157/job/54018396303) |
| mirror_logs | ⏳ In Progress | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18921388157/job/54018396124) |
...
Downloading rignore-0.7.2-cp311-cp311-manylinux_2_17_x86_64.manylinux2014_x86_64.whl (959 kB)
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 959.6/959.6 kB 56.4 MB/s  0:00:00
...
Building wheels for collected packages: awa-common
  ...
  Stored in directory: /tmp/pip-ephem-wheel-cache-hi6zz55a/wheels/58/da/3c/a7efd2bff9f1af19244156fcec46ad0dafb94fdf76dd747f48
...
Error response from daemon: failed to set up container networking: driver failed programming external connectivity on endpoint awa-app-db-1 (8ac50f30300d19e45547ab6acc99a50145166bd6caba6ed8da3ddfa57dcdefff): Bind for 0.0.0.0:5432 failed: port is already allocated
exit_code=1
$ docker compose -f docker-compose.yml -f docker-compose.ci.yml -f docker-compose.postgres.yml -f docker-compose.dev.yml run --rm api alembic history -20
 ...
 Container awa-app-redis-1  Running
 Container awa-app-db-1  Starting
Error response from daemon: failed to set up container networking: driver failed programming external connectivity on endpoint awa-app-db-1 (d4563558e39b91cdfd3e45696097c48f35c47e00c61ec4580779d5bcfc2f3cb6): Bind for 0.0.0.0:5432 failed: port is already allocated
exit_code=1
```
...
postgres-1  | waiting for server to start....2025-10-29 20:39:06.142 UTC [48] LOG:  starting PostgreSQL 16.10 (Debian 16.10-1.pgdg13+1) on x86_64-pc-linux-gnu, compiled by gcc (Debian 14.2.0-19) 14.2.0, 64-bit
postgres-1  | 2025-10-29 20:39:06.142 UTC [48] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
postgres-1  | 2025-10-29 20:39:06.146 UTC [51] LOG:  database system was shut down at 2025-10-29 20:39:06 UTC
postgres-1  | 2025-10-29 20:39:06.150 UTC [48] LOG:  database system is ready to accept connections
postgres-1  |  done
...
postgres-1  | 
postgres-1  | 2025-10-29 20:39:06.338 UTC [48] LOG:  received fast shutdown request
postgres-1  | waiting for server to shut down....2025-10-29 20:39:06.338 UTC [48] LOG:  aborting any active transactions
postgres-1  | 2025-10-29 20:39:06.340 UTC [48] LOG:  background worker "logical replication launcher" (PID 54) exited with exit code 1
postgres-1  | 2025-10-29 20:39:06.342 UTC [49] LOG:  shutting down
postgres-1  | 2025-10-29 20:39:06.342 UTC [49] LOG:  checkpoint starting: shutdown immediate
postgres-1  | 2025-10-29 20:39:06.360 UTC [49] LOG:  checkpoint complete: wrote 926 buffers (5.7%); 0 WAL file(s) added, 0 removed, 0 recycled; write=0.015 s, sync=0.003 s, total=0.019 s; sync files=301, longest=0.001 s, average=0.001 s; distance=4273 kB, estimate=4273 kB; lsn=0/191F0A8, redo lsn=0/191F0A8
postgres-1  | 2025-10-29 20:39:06.369 UTC [48] LOG:  database system is shut down
postgres-1  |  done
postgres-1  | server stopped
postgres-1  | 
postgres-1  | PostgreSQL init process complete; ready for start up.
postgres-1  | 
redis-1     | 1:C 29 Oct 2025 20:39:05.454 # WARNING Memory overcommit must be enabled! Without it, a background save or replication may fail under low memory condition. Being disabled, it can also cause failures without low memory condition, see https://github.com/jemalloc/jemalloc/issues/1328. To fix this issue add 'vm.overcommit_memory = 1' to /etc/sysctl.conf and then reboot or run the command 'sysctl vm.overcommit_memory=1' for this to take effect.
postgres-1  | 2025-10-29 20:39:06.458 UTC [1] LOG:  starting PostgreSQL 16.10 (Debian 16.10-1.pgdg13+1) on x86_64-pc-linux-gnu, compiled by gcc (Debian 14.2.0-19) 14.2.0, 64-bit
postgres-1  | 2025-10-29 20:39:06.458 UTC [1] LOG:  listening on IPv4 address "0.0.0.0", port 5432
postgres-1  | 2025-10-29 20:39:06.458 UTC [1] LOG:  listening on IPv6 address "::", port 5432
postgres-1  | 2025-10-29 20:39:06.460 UTC [1] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
postgres-1  | 2025-10-29 20:39:06.463 UTC [66] LOG:  database system was shut down at 2025-10-29 20:39:06 UTC
postgres-1  | 2025-10-29 20:39:06.467 UTC [1] LOG:  database system is ready to accept connections
redis-1     | 1:C 29 Oct 2025 20:39:05.454 * oO0OoO0OoO0Oo Redis is starting oO0OoO0OoO0Oo
redis-1     | 1:C 29 Oct 2025 20:39:05.454 * Redis version=7.4.6, bits=64, commit=00000000, modified=0, pid=1, just started
redis-1     | 1:C 29 Oct 2025 20:39:05.454 # Warning: no config file specified, using the default config. In order to specify a config file use redis-server /path/to/redis.conf
redis-1     | 1:M 29 Oct 2025 20:39:05.454 * monotonic clock: POSIX clock_gettime
redis-1     | 1:M 29 Oct 2025 20:39:05.455 * Running mode=standalone, port=6379.
redis-1     | 1:M 29 Oct 2025 20:39:05.455 * Server initialized
redis-1     | 1:M 29 Oct 2025 20:39:05.455 * Ready to accept connections tcp
exit_code=0
```
...
awa-app-postgres-1   awa-app-postgres   "docker-entrypoint.s…"   postgres   15 seconds ago   Up 15 seconds (healthy)   0.0.0.0:5432->5432/tcp, [::]:5432->5432/tcp
awa-app-redis-1      redis:7            "docker-entrypoint.s…"   redis      15 seconds ago   Up 15 seconds (healthy)   0.0.0.0:6379->6379/tcp, [::]:6379->6379/tcp
exit_code=0
```
...
GITHUB_ENV=/home/runner/work/_temp/_runner_file_commands/set_env_3bdcc2c7-c1b6-490b-a9e5-3ca79903fbab
GITHUB_EVENT_NAME=pull_request
GITHUB_EVENT_PATH=/home/runner/work/_temp/_github_workflow/event.json
GITHUB_GRAPHQL_URL=https://api.github.com/graphql
GITHUB_HEAD_REF=PR-A
GITHUB_JOB=unit
GITHUB_OUTPUT=/home/runner/work/_temp/_runner_file_commands/set_output_3bdcc2c7-c1b6-490b-a9e5-3ca79903fbab
GITHUB_PATH=/home/runner/work/_temp/_runner_file_commands/add_path_3bdcc2c7-c1b6-490b-a9e5-3ca79903fbab
...
GITHUB_RUN_ID=18921388157
GITHUB_RUN_NUMBER=1282
GITHUB_SERVER_URL=https://github.com
GITHUB_SHA=02212e92f71d0d58fddf1e2a49228e3edd553306
GITHUB_STATE=/home/runner/work/_temp/_runner_file_commands/save_state_3bdcc2c7-c1b6-490b-a9e5-3ca79903fbab
GITHUB_STEP_SUMMARY=/home/runner/work/_temp/_runner_file_commands/step_summary_3bdcc2c7-c1b6-490b-a9e5-3ca79903fbab
GITHUB_TRIGGERING_ACTOR=AlexBomber12
GITHUB_WORKFLOW=ci
GITHUB_WORKFLOW_REF=AlexBomber12/AWA-App/.github/workflows/ci.yml@refs/pull/469/merge
GITHUB_WORKFLOW_SHA=02212e92f71d0d58fddf1e2a49228e3edd553306
...
INVOCATION_ID=58073ecc0fcf49309e2215821bf5135e
ImageOS=ubuntu24
...
RUNNER_NAME=GitHub Actions 1000008746
RUNNER_OS=Linux
RUNNER_TEMP=/home/runner/work/_temp
RUNNER_TOOL_CACHE=/opt/hostedtoolcache
RUNNER_TRACKING_ID=github_0fda5abd-f3ee-4ba0-b071-8a7399845678
