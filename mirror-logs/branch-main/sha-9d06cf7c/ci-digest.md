<!-- AWA-CI-DIGEST -->
## CI digest for `9d06cf7c`

- **Preview URL**: n/a
- **Mirror path**: ci-logs/mirror-logs/branch-main/latest
- **Workflow run**: [18923247624](https://github.com/AlexBomber12/AWA-App/actions/runs/18923247624)

| Job | Conclusion | URL |
| --- | ---------- | --- |
| unit | ❌ Failure | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18923247624/job/54024513979) |
| secrets scan (gitleaks) | ✅ Success | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18923247624/job/54024513984) |
| integration | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18923247624/job/54024705654) |
| migrations | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18923247624/job/54024705668) |
| k6 smoke (non-blocking) | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18923247624/job/54024705702) |
| preview | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18923247624/job/54024705901) |
| mirror_logs | ⏳ In Progress | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18923247624/job/54024705688) |
...
Downloading botocore-1.40.62-py3-none-any.whl (14.1 MB)
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 14.1/14.1 MB 146.5 MB/s  0:00:00
...
Downloading mirakuru-3.0.0-py3-none-any.whl (27 kB)
...
Downloading rignore-0.7.2-cp311-cp311-manylinux_2_17_x86_64.manylinux2014_x86_64.whl (959 kB)
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 959.6/959.6 kB 134.4 MB/s  0:00:00
...
Building wheels for collected packages: awa-common
  ...
  Stored in directory: /tmp/pip-ephem-wheel-cache-nq56ij8o/wheels/58/da/3c/a7efd2bff9f1af19244156fcec46ad0dafb94fdf76dd747f48
...
$ docker compose -f docker-compose.yml -f docker-compose.ci.yml -f docker-compose.postgres.yml -f docker-compose.dev.yml run --rm api alembic current
 ...
 Container awa-app-postgres-1  Started
Error response from daemon: failed to set up container networking: driver failed programming external connectivity on endpoint awa-app-db-1 (3037488ff052562cb9f933ececf8415b8a910b36445b994187019d2ee6c467be): Bind for 0.0.0.0:5432 failed: port is already allocated
exit_code=1
$ docker compose -f docker-compose.yml -f docker-compose.ci.yml -f docker-compose.postgres.yml -f docker-compose.dev.yml run --rm api alembic history -20
 Container awa-app-redis-1  Running
 Container awa-app-postgres-1  Running
 Container awa-app-db-1  Starting
Error response from daemon: failed to set up container networking: driver failed programming external connectivity on endpoint awa-app-db-1 (6af65bad49508cc98effb28ff6de2f39a19ead648894778ce370cd1735dd1ad5): Bind for 0.0.0.0:5432 failed: port is already allocated
exit_code=1
```
...
redis-1  | 1:C 29 Oct 2025 22:01:47.190 # WARNING Memory overcommit must be enabled! Without it, a background save or replication may fail under low memory condition. Being disabled, it can also cause failures without low memory condition, see https://github.com/jemalloc/jemalloc/issues/1328. To fix this issue add 'vm.overcommit_memory = 1' to /etc/sysctl.conf and then reboot or run the command 'sysctl vm.overcommit_memory=1' for this to take effect.
redis-1  | 1:C 29 Oct 2025 22:01:47.190 * oO0OoO0OoO0Oo Redis is starting oO0OoO0OoO0Oo
redis-1  | 1:C 29 Oct 2025 22:01:47.190 * Redis version=7.4.6, bits=64, commit=00000000, modified=0, pid=1, just started
redis-1  | 1:C 29 Oct 2025 22:01:47.190 # Warning: no config file specified, using the default config. In order to specify a config file use redis-server /path/to/redis.conf
redis-1  | 1:M 29 Oct 2025 22:01:47.190 * monotonic clock: POSIX clock_gettime
redis-1  | 1:M 29 Oct 2025 22:01:47.191 * Running mode=standalone, port=6379.
redis-1  | 1:M 29 Oct 2025 22:01:47.191 * Server initialized
redis-1  | 1:M 29 Oct 2025 22:01:47.192 * Ready to accept connections tcp
...
postgres-1  | waiting for server to start....2025-10-29 22:01:47.825 UTC [48] LOG:  starting PostgreSQL 16.10 (Debian 16.10-1.pgdg13+1) on x86_64-pc-linux-gnu, compiled by gcc (Debian 14.2.0-19) 14.2.0, 64-bit
postgres-1  | 2025-10-29 22:01:47.826 UTC [48] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
postgres-1  | 2025-10-29 22:01:47.830 UTC [51] LOG:  database system was shut down at 2025-10-29 22:01:47 UTC
postgres-1  | 2025-10-29 22:01:47.834 UTC [48] LOG:  database system is ready to accept connections
postgres-1  |  done
...
postgres-1  | 
postgres-1  | 2025-10-29 22:01:48.018 UTC [48] LOG:  received fast shutdown request
postgres-1  | waiting for server to shut down....2025-10-29 22:01:48.019 UTC [48] LOG:  aborting any active transactions
postgres-1  | 2025-10-29 22:01:48.021 UTC [48] LOG:  background worker "logical replication launcher" (PID 54) exited with exit code 1
postgres-1  | 2025-10-29 22:01:48.022 UTC [49] LOG:  shutting down
postgres-1  | 2025-10-29 22:01:48.022 UTC [49] LOG:  checkpoint starting: shutdown immediate
postgres-1  | 2025-10-29 22:01:48.044 UTC [49] LOG:  checkpoint complete: wrote 926 buffers (5.7%); 0 WAL file(s) added, 0 removed, 0 recycled; write=0.018 s, sync=0.003 s, total=0.023 s; sync files=301, longest=0.001 s, average=0.001 s; distance=4273 kB, estimate=4273 kB; lsn=0/191F0A8, redo lsn=0/191F0A8
postgres-1  | 2025-10-29 22:01:48.051 UTC [48] LOG:  database system is shut down
postgres-1  |  done
postgres-1  | server stopped
postgres-1  | 
postgres-1  | PostgreSQL init process complete; ready for start up.
postgres-1  | 
postgres-1  | 2025-10-29 22:01:48.138 UTC [1] LOG:  starting PostgreSQL 16.10 (Debian 16.10-1.pgdg13+1) on x86_64-pc-linux-gnu, compiled by gcc (Debian 14.2.0-19) 14.2.0, 64-bit
postgres-1  | 2025-10-29 22:01:48.138 UTC [1] LOG:  listening on IPv4 address "0.0.0.0", port 5432
postgres-1  | 2025-10-29 22:01:48.138 UTC [1] LOG:  listening on IPv6 address "::", port 5432
postgres-1  | 2025-10-29 22:01:48.140 UTC [1] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
postgres-1  | 2025-10-29 22:01:48.142 UTC [66] LOG:  database system was shut down at 2025-10-29 22:01:48 UTC
postgres-1  | 2025-10-29 22:01:48.146 UTC [1] LOG:  database system is ready to accept connections
exit_code=0
```
...
GITHUB_BASE_REF=
GITHUB_ENV=/home/runner/work/_temp/_runner_file_commands/set_env_0cd8c6f0-e46d-41da-9dd0-503a72483644
GITHUB_EVENT_NAME=push
GITHUB_EVENT_PATH=/home/runner/work/_temp/_github_workflow/event.json
GITHUB_GRAPHQL_URL=https://api.github.com/graphql
GITHUB_HEAD_REF=
GITHUB_JOB=unit
GITHUB_OUTPUT=/home/runner/work/_temp/_runner_file_commands/set_output_0cd8c6f0-e46d-41da-9dd0-503a72483644
GITHUB_PATH=/home/runner/work/_temp/_runner_file_commands/add_path_0cd8c6f0-e46d-41da-9dd0-503a72483644
...
GITHUB_RUN_ID=18923247624
GITHUB_RUN_NUMBER=1286
GITHUB_SERVER_URL=https://github.com
GITHUB_SHA=9d06cf7c3d1c2e78fd68b972200f946853697479
GITHUB_STATE=/home/runner/work/_temp/_runner_file_commands/save_state_0cd8c6f0-e46d-41da-9dd0-503a72483644
GITHUB_STEP_SUMMARY=/home/runner/work/_temp/_runner_file_commands/step_summary_0cd8c6f0-e46d-41da-9dd0-503a72483644
GITHUB_TRIGGERING_ACTOR=AlexBomber12
GITHUB_WORKFLOW=ci
GITHUB_WORKFLOW_REF=AlexBomber12/AWA-App/.github/workflows/ci.yml@refs/heads/main
GITHUB_WORKFLOW_SHA=9d06cf7c3d1c2e78fd68b972200f946853697479
...
INVOCATION_ID=95413542b85e4a09951c3fed0cf2b81b
ImageOS=ubuntu24
...
RUNNER_NAME=GitHub Actions 1000008768
RUNNER_OS=Linux
RUNNER_TEMP=/home/runner/work/_temp
RUNNER_TOOL_CACHE=/opt/hostedtoolcache
RUNNER_TRACKING_ID=github_96a9a9f2-1350-4944-ba72-bad86d9de481
