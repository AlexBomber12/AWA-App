<!-- AWA-CI-DIGEST -->
## CI digest for `4ecc6480`

- **Preview URL**: n/a
- **Mirror path**: ci-logs/mirror-logs/branch-main/latest
- **Workflow run**: [18922796004](https://github.com/AlexBomber12/AWA-App/actions/runs/18922796004)

| Job | Conclusion | URL |
| --- | ---------- | --- |
| unit | ❌ Failure | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18922796004/job/54022959830) |
| secrets scan (gitleaks) | ✅ Success | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18922796004/job/54022959832) |
| migrations | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18922796004/job/54023139718) |
| k6 smoke (non-blocking) | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18922796004/job/54023139927) |
| integration | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18922796004/job/54023139929) |
| preview | ⚪ Skipped | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18922796004/job/54023140097) |
| mirror_logs | ⏳ In Progress | [Logs](https://github.com/AlexBomber12/AWA-App/actions/runs/18922796004/job/54023139792) |
...
Downloading botocore-1.40.62-py3-none-any.whl (14.1 MB)
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 14.1/14.1 MB 51.3 MB/s  0:00:00
...
Downloading rignore-0.7.2-cp311-cp311-manylinux_2_17_x86_64.manylinux2014_x86_64.whl (959 kB)
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 959.6/959.6 kB 67.1 MB/s  0:00:00
...
Building wheels for collected packages: awa-common
  ...
  Stored in directory: /tmp/pip-ephem-wheel-cache-jyquawbn/wheels/58/da/3c/a7efd2bff9f1af19244156fcec46ad0dafb94fdf76dd747f48
...
Error response from daemon: failed to set up container networking: driver failed programming external connectivity on endpoint awa-app-postgres-1 (413ae24f93a7433dccee276d779b0c3260552de81ac043c8a73f5357f7dbc476): Bind for 0.0.0.0:5432 failed: port is already allocated
exit_code=1
$ docker compose -f docker-compose.yml -f docker-compose.ci.yml -f docker-compose.postgres.yml -f docker-compose.dev.yml run --rm api alembic history -20
 ...
 Container awa-app-postgres-1  Starting
Error response from daemon: failed to set up container networking: driver failed programming external connectivity on endpoint awa-app-postgres-1 (6094929a74b8c60f5284677e0fb4d1861c64d851229937783270869a15ca65ea): Bind for 0.0.0.0:5432 failed: port is already allocated
exit_code=1
```
...
redis-1  | 1:C 29 Oct 2025 21:38:04.833 # WARNING Memory overcommit must be enabled! Without it, a background save or replication may fail under low memory condition. Being disabled, it can also cause failures without low memory condition, see https://github.com/jemalloc/jemalloc/issues/1328. To fix this issue add 'vm.overcommit_memory = 1' to /etc/sysctl.conf and then reboot or run the command 'sysctl vm.overcommit_memory=1' for this to take effect.
redis-1  | 1:C 29 Oct 2025 21:38:04.833 * oO0OoO0OoO0Oo Redis is starting oO0OoO0OoO0Oo
redis-1  | 1:C 29 Oct 2025 21:38:04.833 * Redis version=7.4.6, bits=64, commit=00000000, modified=0, pid=1, just started
redis-1  | 1:C 29 Oct 2025 21:38:04.833 # Warning: no config file specified, using the default config. In order to specify a config file use redis-server /path/to/redis.conf
redis-1  | 1:M 29 Oct 2025 21:38:04.834 * monotonic clock: POSIX clock_gettime
redis-1  | 1:M 29 Oct 2025 21:38:04.835 * Running mode=standalone, port=6379.
redis-1  | 1:M 29 Oct 2025 21:38:04.835 * Server initialized
redis-1  | 1:M 29 Oct 2025 21:38:04.835 * Ready to accept connections tcp
...
postgres-1  | 
postgres-1  | waiting for server to start....2025-10-29 21:38:05.351 UTC [47] LOG:  starting PostgreSQL 16.10 (Debian 16.10-1.pgdg13+1) on x86_64-pc-linux-gnu, compiled by gcc (Debian 14.2.0-19) 14.2.0, 64-bit
postgres-1  | 2025-10-29 21:38:05.351 UTC [47] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
postgres-1  | 2025-10-29 21:38:05.353 UTC [50] LOG:  database system was shut down at 2025-10-29 21:38:05 UTC
postgres-1  | 2025-10-29 21:38:05.356 UTC [47] LOG:  database system is ready to accept connections
postgres-1  |  done
...
postgres-1  | 
postgres-1  | 2025-10-29 21:38:05.520 UTC [47] LOG:  received fast shutdown request
postgres-1  | waiting for server to shut down....2025-10-29 21:38:05.520 UTC [47] LOG:  aborting any active transactions
postgres-1  | 2025-10-29 21:38:05.522 UTC [47] LOG:  background worker "logical replication launcher" (PID 53) exited with exit code 1
postgres-1  | 2025-10-29 21:38:05.523 UTC [48] LOG:  shutting down
postgres-1  | 2025-10-29 21:38:05.523 UTC [48] LOG:  checkpoint starting: shutdown immediate
postgres-1  | 2025-10-29 21:38:05.538 UTC [48] LOG:  checkpoint complete: wrote 926 buffers (5.7%); 0 WAL file(s) added, 0 removed, 0 recycled; write=0.012 s, sync=0.003 s, total=0.016 s; sync files=301, longest=0.001 s, average=0.001 s; distance=4273 kB, estimate=4273 kB; lsn=0/191F0A8, redo lsn=0/191F0A8
postgres-1  | 2025-10-29 21:38:05.543 UTC [47] LOG:  database system is shut down
postgres-1  |  done
postgres-1  | server stopped
postgres-1  | 
postgres-1  | PostgreSQL init process complete; ready for start up.
postgres-1  | 
postgres-1  | 2025-10-29 21:38:05.635 UTC [1] LOG:  starting PostgreSQL 16.10 (Debian 16.10-1.pgdg13+1) on x86_64-pc-linux-gnu, compiled by gcc (Debian 14.2.0-19) 14.2.0, 64-bit
postgres-1  | 2025-10-29 21:38:05.635 UTC [1] LOG:  listening on IPv4 address "0.0.0.0", port 5432
postgres-1  | 2025-10-29 21:38:05.635 UTC [1] LOG:  listening on IPv6 address "::", port 5432
postgres-1  | 2025-10-29 21:38:05.636 UTC [1] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
postgres-1  | 2025-10-29 21:38:05.638 UTC [65] LOG:  database system was shut down at 2025-10-29 21:38:05 UTC
postgres-1  | 2025-10-29 21:38:05.641 UTC [1] LOG:  database system is ready to accept connections
exit_code=0
```
...
awa-app-postgres-1   awa-app-postgres   "docker-entrypoint.s…"   postgres   12 seconds ago   Up 12 seconds (healthy)   0.0.0.0:5432->5432/tcp, [::]:5432->5432/tcp
awa-app-redis-1      redis:7            "docker-entrypoint.s…"   redis      12 seconds ago   Up 12 seconds (healthy)   0.0.0.0:6379->6379/tcp, [::]:6379->6379/tcp
exit_code=0
```
...
GITHUB_BASE_REF=
GITHUB_ENV=/home/runner/work/_temp/_runner_file_commands/set_env_d0439a4e-7545-47ab-835e-dc2e45bb0471
GITHUB_EVENT_NAME=push
GITHUB_EVENT_PATH=/home/runner/work/_temp/_github_workflow/event.json
GITHUB_GRAPHQL_URL=https://api.github.com/graphql
GITHUB_HEAD_REF=
GITHUB_JOB=unit
GITHUB_OUTPUT=/home/runner/work/_temp/_runner_file_commands/set_output_d0439a4e-7545-47ab-835e-dc2e45bb0471
GITHUB_PATH=/home/runner/work/_temp/_runner_file_commands/add_path_d0439a4e-7545-47ab-835e-dc2e45bb0471
...
GITHUB_RUN_ID=18922796004
GITHUB_RUN_NUMBER=1285
GITHUB_SERVER_URL=https://github.com
GITHUB_SHA=4ecc648059fae7799dfd4365998521884b036032
GITHUB_STATE=/home/runner/work/_temp/_runner_file_commands/save_state_d0439a4e-7545-47ab-835e-dc2e45bb0471
GITHUB_STEP_SUMMARY=/home/runner/work/_temp/_runner_file_commands/step_summary_d0439a4e-7545-47ab-835e-dc2e45bb0471
GITHUB_TRIGGERING_ACTOR=AlexBomber12
GITHUB_WORKFLOW=ci
GITHUB_WORKFLOW_REF=AlexBomber12/AWA-App/.github/workflows/ci.yml@refs/heads/main
GITHUB_WORKFLOW_SHA=4ecc648059fae7799dfd4365998521884b036032
...
INVOCATION_ID=0673b46bcbdd473e87463ba707d54d45
ImageOS=ubuntu24
...
RUNNER_NAME=GitHub Actions 1000008764
RUNNER_OS=Linux
RUNNER_TEMP=/home/runner/work/_temp
RUNNER_TOOL_CACHE=/opt/hostedtoolcache
RUNNER_TRACKING_ID=github_df0f59b6-f08c-4657-8d3e-3eaf58634c29
