...
def _pii_scrubber(event: Mapping[str, Any], _hint: Any | None = None) -> MutableMapping[str, Any] | None:
...
def _breadcrumb_scrubber(breadcrumb: Mapping[str, Any], _hint: Any | None = None) -> MutableMapping[str, Any] | None:
